...
async function connectClient(repository: InMemoryOrchestrationRepository): Promise<Client> {
  const server = createProjectMcpServer({ repository, principal: { type: "agent", id: "codex" } });
